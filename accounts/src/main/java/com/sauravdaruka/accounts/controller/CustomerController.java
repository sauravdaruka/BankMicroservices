...
import com.sauravdaruka.accounts.dto.ErrorResponseDto;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
        ...
        // To this logger statement openTelemetry at runtime is going to inject application name, trace ID and the span ID, so correlationId is not required in @RequestHeader
